...
Как использовать наследования и включение?
...
💊 Сущность включения проста: один класс содержит другой класс или примитивный элемент данных. При помощи включение следует реализовывать отношение типа «‎содержит».
